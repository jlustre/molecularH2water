  ...
  groups: [
    {
      ...
      links: [
        ...
        {
          description: "Hear what hydrogen water users are saying.",
          href: "/testimonials",
          icon: Quote,
          key: "testimonials",
          label: "Testimonials",
    ...
    {
      description: "Real-world experiences shared by hydrogen water users.",
      icon: Quote,
      key: "testimonials",
      title: "Testimonials",
      links: [
        {
          description: "See every hydrogen water user story in one place.",
        ...
        {
          description: "Retired AHL/NHL athlete on energy, clarity, and recovery.",
          href: "/testimonials#mark-messier",
          icon: Award,
          key: "mark-messier",
          label: "Mark Messier",
        },
        {
          description: "10x Ironman and ultra marathoner on endurance and focus.",
          href: "/testimonials#tim-s",
          icon: Activity,
          key: "tim-s",
          label: "Tim S.",
        },
        {
          description: "Coach and bodybuilder on workout recovery.",
          href: "/testimonials#thomas-b",
          icon: Zap,
          key: "thomas-b",
          label: "Thomas B.",
        },
        {
          description: "Cyclist on daily hydration and training recovery.",
          href: "/testimonials#amy-lee",
          icon: Bike,
          key: "amy-lee",
          label: "Amy Lee",
        },
        {
          description: "Nurse on energy and focus through night shifts.",
          href: "/testimonials#lori-stephens",
          icon: HeartPulse,
          key: "lori-stephens",
          label: "Lori Stephens",
        },
        {
          description: "Energy, clarity, recovery, hydration, and daily wellness.",
          href: "/testimonials#common-themes",
          icon: Sparkles,
          key: "common-themes",
          label: "Common Themes",
        },
